-- Rebuild create_task without est_hours / actual_hours
...
BEGIN
  ...
  INSERT INTO tasks(
    ...
    priority, title, description, due_date,
    tags, parent_task_id
  ) VALUES (
...
-- Rebuild update_task without est_hours / actual_hours
...
-- Drop the columns
ALTER TABLE tasks DROP COLUMN IF EXISTS est_hours;
